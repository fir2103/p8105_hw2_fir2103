...
* The total weight of trash collected by Professor Trash Wheel is `r sum(prof_trash_wheel$weight)`. 

* The total number of sports balls collected by Mr. Trash Wheel in 2020 is `r sports_balls_2020`. 
